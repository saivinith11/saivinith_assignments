function findLargest(randomValuesArray) {
    ...
    document.write("Largest No. is: " + largeNo);
  }
  function findSmallest(randomValuesArray) {
    ...
    document.write("Smallest No. is: " + smallNo);
  }
  ...
  function evenoddCount(randomValuesArray) {
    ...
    function sumAndAverage(randomValuesArray) {
      ...
      document.write("Sum of all random Num. is: " + sum);
      document.write("average is: " + sum/randomValuesArray.length);
    }
